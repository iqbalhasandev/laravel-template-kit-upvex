...
!(function () {
    ...
    (p.fn.tinymce = function (o) {
                        ...
                        v().get(i) ||
                            ...
                            n.on("init", function () {
                                ...
                                l.css("visibility", ""),
                                    ...
                                    // this logic will fire the oninit callback ones
                                    // each matched editor instance is initialized
                                    r &&
                                        ++c == a.length &&
                                        ("string" == typeof t &&
                                            ((e =
        ...
        if (d.tinymce || c || !(e = o.script_url))
            ...
            (c = 1),
                ...
                // make sure that all plugins, themes etc are loaded in source mode as
                // well
                -1 != e.indexOf(".min") && (r = ".min"),
                // Setup tinyMCEPreInit object this will later be used by the TinyMCE
                // core script to locate other resources like CSS files, dialogs etc
                // You can also predefined a tinyMCEPreInit object and then it will use
                // that instead
                ...
                -1 != e.indexOf("gzip") &&
                    ...
                    (e =
                        ...
                        "&languages=" +
                        (i || "")),
                    // Check if compressor script is already loaded otherwise setup a
                    // basic one
                    d.tinyMCE_GZ ||
                        (d.tinyMCE_GZ = {
                            start: function () {
                    ...
                    function (e) {
                        (e = e || window.event),
                            2 === c ||
                                ...
                                (c = 2),
                                // Execute callback after mainscript has been loaded and before the
        ...
        // Add :tinymce pseudo selector this will select elements that has been
        // converted into editor instances it's now possible to use things like
        // $('*:tinymce') to get all TinyMCE bound elements.
        p.extend(p.expr[":"], {
            tinymce: function (e) {
                var t;
                return !!(
    ...
    var m = function () {
        ...
        // example $('#editorid').html('Content'); will update the TinyMCE iframe
        // instance
        p.each(["text", "html", "val"], function (e, t) {
            ...
            // Makes it possible to use $('#id').append("content"); to append
            // contents to the TinyMCE editor iframe
            ...
            // Makes sure that the editor instance gets properly destroyed when the
            ...
            (s.attr = p.fn.attr),
            // Makes sure that $('#tinymce_id').attr('value') gets the editors
            // current HTML contents
