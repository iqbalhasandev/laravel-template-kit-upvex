...
!(function (f) {
    ...
    var n,
            ...
            var a = function (t) {
                ...
                t = function (t, n, r) {
                    ...
                    if (v(o.format)) {
                        ...
                        if (!p(o.format))
                            return a(
                                t + " pattern has non-string `format` parameter"
                            );
                        e = [o.format];
                    }
                    return D.value(n(e));
            ...
            return {
                ...
                getPatterns: function () {
                    return (function f() {
                        ...
                        w(e.get().inlinePatterns, q),
                        w(e.get().blockPatterns, q)
                    );
                },
            };
        },
        W =
            "undefined" != typeof f.window
                ? f.window
        ...
        rt = function (t, n) {
            ...
            return (
                v(e) &&
                (0 === (r = e).length ? y.none() : y.some(r[0])).exists(
                    function (t) {
                        return S(t, "block");
                    }
                )
            ...
            if (0 !== t.length) {
                ...
                C(t, function (t) {
                    return (
                        ...
                        (e = (n = i).dom),
                        (o = r.pattern),
                        (a = gt(e.getRoot(), r.range).getOrDie(
        ...
        wt = function (t, n, r) {
            tt(t, t.get(n.prefix + "-end"), r),
                tt(t, t.get(n.prefix + "-start"), r);
        },
        Ct = function (e, o, a, t) {
            var i,
                u = o.start;
