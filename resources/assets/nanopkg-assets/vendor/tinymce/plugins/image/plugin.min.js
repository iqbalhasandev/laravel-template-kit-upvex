...
!(function (m) {
    ...
    var e,
        ...
        ie = function (e) {
            return (
                0 === F.getAttrib(e, "alt").length &&
                "presentation" === F.getAttrib(e, "role")
            );
        },
        oe = function () {
            return {
                ...
                t.selection.select(l),
                    ...
                    (o = function () {
                        (i.onload = i.onerror = null),
                            r.selection &&
                                (r.selection.select(i), r.nodeChanged());
                    }),
                    ((i = l).onload = function () {
                        a.width ||
                            a.height ||
            ...
            if (o !== undefined) {
                ...
                (r = l),
                    ...
                    n.hasAccessibilityOptions &&
                        (r.isDecorative =
                            a.isDecorative || r.isDecorative || !1),
        ...
        a.add("image", function (e) {
            ...
            (t = e).on("PreInit", function () {
                ...
                n.ui.registry.addContextMenu("image", {
                    update: function (e) {
                        return ae(e) || ("IMG" === e.nodeName && !B(e))
                            ? ["image"]
                            : [];
                    },
                }),
