...
!(function (i) {
    ...
    var n,
        ...
        z = function (t) {
            return !(
                !/(^|[ ,])rtc([, ]|$)/.test(t.settings.plugins) || !o.get("rtc")
            );
        },
        I = function (t) {
            return /^\w+:/i.test(t);
        ...
        st = function (t) {
            ...
            return 0 < e.length
                ? P.some([{ text: "None", value: "" }].concat(e))
                : P.none();
        },
        mt = function (t) {
            ...
            return dt(f).then(function (t) {
                var n,
                    ...
                    c =
                        ((e = s),
                        (r = (n = f).dom),
                        (o = H(n.selection.getContent())
                            ? P.some(F(n.selection, e))
                            : P.none()),
                            ...
                            body: {
                                ...
                                items: L([
                                    ...
                                    (function (t) {
                                        ...
                                        g.link.map(
                                            ot.createUi("link", "Link list")
                                        ),
                                        g.classes.map(
                                            ot.createUi("linkClass", "Class")
                                        ),
                                    ]),
                                ]),
                            },
        ...
        _t = function (e) {
            return function (n) {
                var t = function (t) {
                    return n.setActive(
                        !e.mode.isReadOnly() && !!V(e, t.element)
                    );
                };
                return (
                    e.on("NodeChange", t),
