...
!(function (y) {
        ...
        return (
            T.each(e, function (e, t) {
                switch (t) {
                    case "mso-list":
                        (a = /\w+ \w+([0-9]+)/i.exec(o)) &&
                            (i._listLevel = parseInt(a[1], 10)),
                            /Ignore/i.test(e) &&
                                i.firstChild &&
                                ((i._listIgnore = !0),
                                (i.firstChild._listIgnore = !0));
                        break;
                    case "horiz-align":
                        t = "text-align";
                        break;
            ...
            /(bold)/i.test(s["font-weight"]) &&
                (delete s["font-weight"], i.wrap(new E("b", 1))),
            /(italic)/i.test(s["font-style"]) &&
                (delete s["font-style"], i.wrap(new E("i", 1))),
    ...
    var K = function (e, t) {
            ...
            var n,
                ...
                m =
                    e.settings.images_reuse_filename && t.blob.name
                        ? ((i = e),
                          (o = t.blob.name),
                          (a = o.match(/([\s\S]+?)\.(?:jpeg|jpg|png|gif)$/i))
                              ? i.dom.encode(a[1])
                              : null)
                        : d,
                p = new y.Image();
        ...
        me = function (u, l, c) {
            ...
            function m(e, t, n, r) {
                ...
                se(e, "text/html")
                    ...
                    (i.length && (!o || a)) || (n = !0),
                    (n || a) &&
                        (i = se(e, "text/plain") && o ? e["text/plain"] : H(i)),
            ...
            u.on("paste", function (e) {
                ...
                e.isDefaultPrevented() ||
                    ((r = e.clipboardData),
                    -1 !== y.navigator.userAgent.indexOf("Android") &&
                        r &&
                        r.items &&
                        0 === r.items.length))
                    ? l.remove()
                    ...
                    return (function (n) {
                        ...
                        for (
                            e = T.grep(ge(n).childNodes, function (e) {
                                ...
                                r =
                                    (i = n.dom.select("div[id=mcepastebin]", t))
                                        .length - 1;
                            0 <= r;
                            r--
                        )
        ...
        Pe = function (e, t, n, r) {
            we(e.clipboardData, t.html, t.text)
                ? (e.preventDefault(), r())
                : n(t.html, r);
        },
        _e = function (s) {
    ...
    function Ee(e, t, n, r) {
        ...
        if (
            !1 === e.getParam("paste_remove_styles_if_webkit", !0) ||
            "all" === i
        )
            return t;
        if ((i && (l = i.split(/[, ]/)), l)) {
