<x-app-layout>
    <x-card>
        <div class="my-2 text-center">
            <div>
                <button onclick="createBackup('only-db')" class="btn btn-success btn-sm mx-1" id="create-backup"><i
    ...
    <script>
        function createBackup(mode=null) {
            var url="{{ route(config('theme.rprefix').'.create-backup') }}";
    ...
    <script>
        function deleteBackup() {
            var url="{{ route(config('theme.rprefix').'.delete.all') }}";
